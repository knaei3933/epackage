-- =====================================================
-- create_order_from_quotation (Task #20 - ambiguous column fix)
-- Fix: RETURNS TABLE output param `order_number` collided with
-- orders.order_number in the existing-order lookup subquery (42702).
-- Alias the table reference to disambiguate.
-- =====================================================
...
BEGIN
  ...
  -- matches convert route ordering). Alias `o` to avoid ambiguity between the
