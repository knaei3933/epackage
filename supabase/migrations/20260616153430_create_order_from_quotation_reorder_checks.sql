-- =====================================================
-- create_order_from_quotation (Task #20 - check reorder)
-- Reorder: existing-order check BEFORE approval check, mirroring the
-- customer-facing convert route. Idempotent for already-converted quotations.
-- =====================================================
...
BEGIN
  ...
  -- matches convert route ordering). Returns the existing order regardless of
  ...
  -- UPPER-normalize to accept 'approved'/'APPROVED'/'QUOTATION_APPROVED'.
