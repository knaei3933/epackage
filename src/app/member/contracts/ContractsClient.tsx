...
function MemberContractsPageWrapper({ userId }: ContractsClientProps) {
...
export function ContractsClient({ userId }: ContractsClientProps) {
  return (
    <Suspense fallback={<div className="text-center py-12">読み込み中...</div>}>
      <MemberContractsPageWrapper userId={userId} />
    </Suspense>
  );
}
