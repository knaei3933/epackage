/**
 * Member AI Extraction Upload API
 *
 * メンバーAI抽出アップロードAPI
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    if (isDevMode && devModeUserId) {
      ...
      console.log('[AI Extraction Upload] DEV_MODE: Using x-user-id header:', devModeUserId)
      ...
      if (userIdFromMiddleware && isFromMiddleware) {
        ...
        console.log('[AI Extraction Upload] Using user ID from middleware:', userId)
      } else {
