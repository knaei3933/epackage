...
export const metadata: Metadata = {
  ...
  title: {
    default: "Epackage Lab - 最小500枚・最短28日納品 | パッケージ印刷で革新する小ロット製造",
    template: "%s | Epackage Lab"
  },
  description: "最小500枚から最短28日納品が可能なパッケージ製造プラットフォームEpackage Lab。高品質な印刷技術とデジタル技術を融合させた新しいものづくりを提供します。年間300万円の在庫廃棄コストを70%削減。500社以上の日本企業実績、食品安全規格完全対応。",
  keywords: [
    // 基本キーワード
    ...
    "500枚から", "28日納品", "小ロット対応", "最小500枚", "最短28日",
    // ものづくり・革新（競合分析に基づき追加）
