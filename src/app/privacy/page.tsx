              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <div className="space-y-3 text-text-secondary leading-relaxed">
                    ...
                    <p className="mt-4">
                      初回ご訪問時に Cookie の使用に関する同意バナーを表示します。お客様は「すべて許可」「すべて拒否」または個別の設定から、分析クッキー・マーケティングクッキーそれぞれについて選択できます。選択内容は12ヶ月間保存され、ブラウザのデータを消去することで再設定できます。
                    </p>
                    <p>
                      お客様はブラウザの設定によりクッキーの受け取りを拒否することもできます。ただし、クッキーを無効にすると、一部の機能が正常に動作しない場合があります。
                    </p>
                  </div>
                </div>
              </div>
