      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        {orderStats && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
            {/* 見積承認待ち */}
            <Link href="/admin/quotations" className="bg-yellow-50 rounded-lg shadow-sm p-6 border border-yellow-200 hover:bg-yellow-100 transition-colors">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-yellow-700">見積承認待ち</p>
                  <p className="text-2xl font-bold text-yellow-800 mt-1">
                    {orderStats.pendingQuotations || 0}
                  </p>
            ...
            <div className="bg-green-50 rounded-lg shadow-sm p-6 border border-green-200">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-green-700">見積承認済み</p>
                  <p className="text-2xl font-bold text-green-800 mt-1">
                    {orderStats.quotations?.approved || 0}
                  </p>
                  <p className="text-xs text-green-600 mt-1">
                    {orderStats.quotations?.total || 0} 件中
                  </p>
                </div>
            ...
            <div className="bg-blue-50 rounded-lg shadow-sm p-6 border border-blue-200">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-blue-700">見積コンバージョン率</p>
