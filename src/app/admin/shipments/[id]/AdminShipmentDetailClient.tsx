...
import { TrackingHistorySection } from './parts/TrackingHistorySection';
...
export default function AdminShipmentDetailClient() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        {/* 配送追跡履歴 */}
        <TrackingHistorySection shipment={shipment} />
      </div>
    </div>
  );
}
