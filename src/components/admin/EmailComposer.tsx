...
import { Recipient, EmailAttachment, EmailComposerProps, EmailComposerMode, ANIMATION_VARIANTS, MAX_ATTACHMENT_SIZE, ACCEPTED_FILE_TYPES, EMAIL_SIGNATURE } from './parts/emailTypes';

// Re-export for backward compatibility
export type { Recipient, EmailAttachment, EmailComposerProps, EmailComposerMode } from './parts/emailTypes';
import { formatFileSize, getFileIconColor, fileToBase64, validateEmail } from './parts/emailUtils';
import { RecipientChip, AttachmentCard } from './parts/EmailSubComponents';
