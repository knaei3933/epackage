...
export const processingOptionsConfig: ProcessingOptionConfig[] = [
  ...
  // 5-1. Corner Round (角丸)
  {
    ...
    beforeImage: '/images/post-processing/5.角直.png',
  ...
  },
  {
    ...
    beforeImage: '/images/post-processing/5.角直.png',
    afterImage: '/images/post-processing/5.角直.png',
    thumbnail: '/images/post-processing/5.角直.png',
    priceMultiplier: 1.00,
  ...
  // 7-1. Top Open (上端開封)
  {
    ...
    beforeImage: '/images/post-processing/6.下端オープン.png',
    afterImage: '/images/post-processing/6.上端オープン.png',
    thumbnail: '/images/post-processing/6.上端オープン.png',
    priceMultiplier: 1.0,
  ...
  },
  {
    ...
    beforeImage: '/images/post-processing/6.上端オープン.png',
    afterImage: '/images/post-processing/6.下端オープン.png',
    thumbnail: '/images/post-processing/6.下端オープン.png',
    priceMultiplier: 1.0,
