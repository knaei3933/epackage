 ...
 *
 * Generates the HTML for single quote PDFs.
 */

import type { QuoteData } from './types';
import { JAPANESE_CONSTANTS } from './constants';
import {
  formatJapaneseDate, formatWesternDate, formatYen, calculateTotals,
  isZipperIncompatible, isCornerIncompatible, isSpoutPouchIncompatible,
} from './format-helpers';
