...
// Types (imported for local use + re-exported for backward compatibility)
import type {
  PouchDimensions,
  EconomicQuantitySuggestion,
  ParallelProductionOption,
  SKUCostParams,
  PouchProcessingSettings,
  SKUCostBreakdown,
  SKUCostResult,
  SKUSplitOption,
} from './pouch/types';
...
import {
  calculateOptimalColumnCount as _calculateOptimalColumnCount,
  calculateFilmWidth as _calculateFilmWidth,
  calculateTheoreticalMeters as _calculateTheoreticalMeters,
  calculateSecuredMeters as _calculateSecuredMeters,
  selectMaterialWidth as _selectMaterialWidth,
  roundDownToHundreds as _roundDownToHundreds,
} from './pouch/geometry';
import {
  getMaterialInfo as _getMaterialInfo,
  adjustLayersForThickness as _adjustLayersForThickness,
  calculateDeliveryWeight as _calculateDeliveryWeight,
} from './pouch/material-helpers';
// Type definitions moved to ./pouch/types.ts (re-exported above)
