...
// Types imported from extracted modules
import type {
  UnifiedQuoteParams,
  UnifiedQuoteResult,
  ThicknessOption,
...
import { MATERIAL_THICKNESS_OPTIONS } from './pricing/material-options';
export { MATERIAL_THICKNESS_OPTIONS } from './pricing/material-options';
