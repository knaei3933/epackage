...
export const getServerClient = () => {
  ...
  if (!supabaseUrl || !supabaseAnonKey) {
    ...
    const createQueryMock = () => ({
      ...
      not: (column: string, operator: string, value: any) => createQueryMock(),
      is: (column: string, value: any) => createQueryMock(),
      or: (filters: string) => createQueryMock(),
      filter: (column: string, operator: string, value: any) => createQueryMock(),
