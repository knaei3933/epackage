...
import MultiQuantityComparisonTable from '@/components/quote/MultiQuantityComparisonTable.optimized';
import QuantityEfficiencyChart from '@/components/quote/QuantityEfficiencyChart.optimized';
import { optimizedMultiQuantityCalculator } from '@/lib/multi-quantity-calculator.optimized';
import { networkOptimizer } from '@/lib/network-optimizer';
...
const mockComparison = {
  ...
  economiesOfScale: mockQuotes.reduce((acc, q) => {
    acc[q.quantity] = {
      ...
      totalSavings: q.totalSavings * 0.1,
