...
async function main() {
  console.log('=== Update QT20260330-3673 Film Cost Details ===\n');
  ...
  for (const item of items || []) {
    ...
    console.log('Current PET weight:', specs.film_cost_details?.materialLayerDetails?.[0]?.weightKg);
    ...
    if (filmCostDetails && filmCostDetails.materialLayerDetails) {
      ...
      console.log('\nNew PET weight:', filmCostDetails.materialLayerDetails[0]?.weightKg);
